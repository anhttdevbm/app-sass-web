...
const Question = () => {
    const { isFetching, error, questions, onGetAboutUsQuestion, onUpdateAboutUsQuestion } = useContentAboutUs()
        ...
        <>
            ...
            {action === DataAction.UPDATE && (
                <Form
                    ...
                    onSubmit={(values) => onUpdateAboutUsQuestion(values)}
                    titleForm={contentT("aboutUs.updateQuestion")}
                    name={contentT("aboutUs.question")}
                />
            )}
        </>
    )
