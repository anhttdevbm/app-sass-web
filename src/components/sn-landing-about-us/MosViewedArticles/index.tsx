...
const MostViewedArticles = () => {
    const { isFetching, error, articles, onGetAboutUsMostViewArticles, onUpdateAboutUsMostViewArticles } = useContentAboutUs()
    ...
    const handleUpdateAboutUsMostViewArticles = async(values: ArticleData[]) => {
        const response = await onUpdateAboutUsMostViewArticles(values)
        if (!response) return
        await onGetAboutUsMostViewArticles()
        return response
    }
        ...
        <>
            <StatusServer isFetching={isFetching} error={error}>
                ...
                >
                    ...
                    >
                        <Text variant="h4">
                            {contentT("aboutUs.mostViewedArticles")}
                        </Text>
                        <IconButton
            ...
            {action === DataAction.UPDATE && (
                <Form
                    ...
                    onSubmit={handleUpdateAboutUsMostViewArticles}
...
export default memo(MostViewedArticles)