...
const Sidebar = () => {
  ...
  return (
    <Box sx={styles}>
      <NewButton sx={addNewBtnSx} startIcon={<PlusFillIcon style={{ fontSize: "24px" }}/>}>{t('sideBar.newChat')}</NewButton>
      <ChatList chats={chats} />
      <NewButton startIcon={<TrashFillIcon />} sx={clearAllBtnSx}>{t('sideBar.clearConversations')}</NewButton>
    </Box>
  );
};
