...
import { getMentionModule, mentionModuleConfig } from "./mentionModule";
...
const EditorCustom = (props: EditorProps) => {
  ...
  const onInit = useCallback(async () => {
    ...
    // const Mention = await getMentionModule(); // Dynamically import the mention module
    RQuill.Quill.register({
      "blots/mention": MentionBlot,
      "modules/mention": Mention,
    });
    // if (Mention) {
    //   RQuill.Quill.register("modules/mention", Mention);
    // } else {
    //   console.error("Mention module is not loaded correctly");
    // }
        ...
        <Stack style={{ width: "100%", flex: 1 }}>
          <TextEditor
            ...
            modules={{
              ...
              //   },
              //   renderItem: (item: any) => `<div>${item.value}</div>`,
              // }, // Add the mention module here
            }}
