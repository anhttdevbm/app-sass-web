  ...
  return (
    <Stack justifyContent={"center"} alignItems={"start"} gap={"12px"}>
      ...
      >
        ...
        >
          <Typography
            sx={{ fontWeight: 700, fontSize: 13, color: "#172B4D" }}
          >
        ...
        <Stack display={{ xs: "block", sm: "none", md: "none" }}>
          <div style={{ position: 'relative', width: 170 }}>
            ...
            >
              <span>
                {selectedActivity ?
                  ` ${t(`ticketDetail.activity.show`)} : ${t(`ticketDetail.activity.${selectedActivity}`)}`
                  : t(`ticketDetail.activity.show`)}
              </span>
                ...
                {listTypeActivity.map((it, index) => (
                  <div
                    ...
                    style={{
                      padding: '8px 14px',
                      cursor: 'pointer',
                      backgroundColor: selectedActivity === it ? '#D9F0FD' : '#FFFFFF',
                      fontSize: '13px',
                      fontWeight: 700,
                      color: '#172B4D',
