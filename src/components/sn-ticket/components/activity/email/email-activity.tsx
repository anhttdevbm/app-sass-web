            ...
            <Box p={1} display="flex" justifyContent="space-between" alignItems="center">
              ...
              <Button
                ...
                <svg width="16" height="13" viewBox="0 0 16 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.33333 3.5013V0.167969L0.5 6.0013L6.33333 11.8346V8.41797C10.5 8.41797 13.4167 9.7513 15.5 12.668C14.6667 8.5013 12.1667 4.33464 6.33333 3.5013Z" fill="black" fill-opacity="0.54" />
                </svg>
                <Text
                  fontSize={13}
